...
source_guests="sweep git-repo pack salesforce graph-calendar graph-mail graph-chats graph-meetings graph-org-calendar graph-org-meetings microsoft-files"
